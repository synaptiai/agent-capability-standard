...
description: Detect an activity/event pattern occurring in data.
...
## Intent
Execute **detect-activity** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `detect-activity`
