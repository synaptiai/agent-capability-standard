---
name: compare-plans
description: Compare plans by feasibility, risk, cost, speed, quality.
...
## Intent
Execute **compare-plans** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `compare-plans`
