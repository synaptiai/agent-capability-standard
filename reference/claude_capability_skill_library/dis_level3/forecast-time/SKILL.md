---
name: forecast-time
description: Forecast timing of an event/state transition.
...
## Intent
Execute **forecast-time** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `forecast-time`
