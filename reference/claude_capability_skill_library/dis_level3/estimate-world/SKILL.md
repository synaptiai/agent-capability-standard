---
name: estimate-world
description: Estimate world/system state variables from observations.
...
## Intent
Execute **estimate-world** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `estimate-world`
