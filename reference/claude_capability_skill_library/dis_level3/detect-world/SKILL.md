---
name: detect-world
description: Detect a world state/context condition (environmental/system).
...
## Intent
Execute **detect-world** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `detect-world`
