...
description: Estimate impact of an intervention/choice.
...
## Intent
Execute **estimate-impact** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `estimate-impact`
