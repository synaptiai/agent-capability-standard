---
name: generate-world
description: Generate a world-state scenario consistent with constraints.
...
## Intent
Execute **generate-world** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `generate-world`
