...
description: Identify which attribute value applies.
...
## Intent
Execute **identify-attribute** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `identify-attribute`
