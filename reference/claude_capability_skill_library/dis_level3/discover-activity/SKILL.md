...
description: Discover activities/events implicitly present in data.
...
## Intent
Execute **discover-activity** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `discover-activity`
