...
description: Estimate attribute values (continuous/ordinal) from evidence.
...
## Intent
Execute **estimate-attribute** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `estimate-attribute`
