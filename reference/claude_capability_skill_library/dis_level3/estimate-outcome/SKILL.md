...
description: Estimate outcome value/likelihood given inputs.
...
## Intent
Execute **estimate-outcome** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `estimate-outcome`
