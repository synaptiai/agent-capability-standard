---
name: generate-plan
description: Generate a plan with steps, dependencies, and verification.
...
## Intent
Execute **generate-plan** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `generate-plan`
