...
description: Identify the activity/event type from signals.
...
## Intent
Execute **identify-activity** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `identify-activity`
