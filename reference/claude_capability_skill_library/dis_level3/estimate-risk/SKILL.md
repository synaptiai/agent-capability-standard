---
name: estimate-risk
description: Estimate risk probability/impact and contributing factors.
...
## Intent
Execute **estimate-risk** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `estimate-risk`
