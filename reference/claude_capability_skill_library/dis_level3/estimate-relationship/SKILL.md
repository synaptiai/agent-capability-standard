...
description: Estimate strength/type of relationship between entities.
...
## Intent
Execute **estimate-relationship** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `estimate-relationship`
