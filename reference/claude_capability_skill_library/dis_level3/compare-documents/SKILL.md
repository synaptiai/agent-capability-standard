...
description: Compare documents for differences, alignment, and gaps.
...
## Intent
Execute **compare-documents** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `compare-documents`
