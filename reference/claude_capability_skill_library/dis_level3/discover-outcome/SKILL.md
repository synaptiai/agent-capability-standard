...
description: Discover outcomes/patterns from historical evidence.
...
## Intent
Execute **discover-outcome** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `discover-outcome`
