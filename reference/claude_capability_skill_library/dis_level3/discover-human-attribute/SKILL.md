...
description: Discover human attribute patterns (non-sensitive) from evidence.
...
## Intent
Execute **discover-human-attribute** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `discover-human-attribute`
