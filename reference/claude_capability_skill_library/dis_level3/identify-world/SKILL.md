---
name: identify-world
description: Identify the world/system context state from evidence.
...
## Intent
Execute **identify-world** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `identify-world`
