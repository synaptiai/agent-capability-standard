...
description: Discover anomalies without a pre-defined expectation.
...
## Intent
Execute **discover-anomaly** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `discover-anomaly`
