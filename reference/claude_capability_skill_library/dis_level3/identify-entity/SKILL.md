...
description: Identify which entity/object matches evidence.
...
## Intent
Execute **identify-entity** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `identify-entity`
