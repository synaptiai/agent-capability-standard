...
description: Identify a human attribute (non-sensitive) from evidence.
...
## Intent
Execute **identify-human-attribute** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `identify-human-attribute`
