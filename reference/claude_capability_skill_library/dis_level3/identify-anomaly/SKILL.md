...
description: Identify the type/category of an anomaly.
...
## Intent
Execute **identify-anomaly** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `identify-anomaly`
