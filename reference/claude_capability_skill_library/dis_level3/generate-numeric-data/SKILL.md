...
description: Generate numeric data/synthetic dataset with schema and constraints.
...
## Intent
Execute **generate-numeric-data** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `generate-numeric-data`
...
- Constraints used: <explicit>
- Rationale: <why this satisfies constraints>
- Safety notes: <what was avoided>
- Next actions: 0–3
