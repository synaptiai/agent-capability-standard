...
description: Compare entities across explicit criteria and constraints.
argument-hint: "[optionA] [optionB] [criteria]"
...
## Intent
Execute **compare-entities** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `compare-entities`
