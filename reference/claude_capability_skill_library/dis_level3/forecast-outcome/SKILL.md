...
description: Forecast outcomes conditional on scenarios.
...
## Intent
Execute **forecast-outcome** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `forecast-outcome`
