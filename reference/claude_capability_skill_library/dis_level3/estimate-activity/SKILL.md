...
description: Estimate activity intensity/duration/likelihood.
...
## Intent
Execute **estimate-activity** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `estimate-activity`
