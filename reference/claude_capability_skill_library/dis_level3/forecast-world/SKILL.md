---
name: forecast-world
description: Forecast world/system state over horizon.
...
## Intent
Execute **forecast-world** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `forecast-world`
