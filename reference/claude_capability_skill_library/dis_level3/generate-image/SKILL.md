---
name: generate-image
description: Generate image (or image prompt/spec) under constraints.
...
## Intent
Execute **generate-image** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `generate-image`
