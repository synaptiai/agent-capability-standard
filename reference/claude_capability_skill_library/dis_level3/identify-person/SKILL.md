...
description: Identify a person (role/identity proxy) from evidence, without doxxing.
...
## Intent
Execute **identify-person** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `identify-person`
