...
description: Discover previously unknown relationships between entities.
...
## Intent
Execute **discover-relationship** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `discover-relationship`
