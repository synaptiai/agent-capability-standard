---
name: detect-person
description: Detect presence of a person (or person-like subject) in data.
...
## Intent
Execute **detect-person** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `detect-person`
