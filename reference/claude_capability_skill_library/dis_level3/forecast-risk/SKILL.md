---
name: forecast-risk
description: Forecast risk trajectory and triggers.
...
## Intent
Execute **forecast-risk** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `forecast-risk`
