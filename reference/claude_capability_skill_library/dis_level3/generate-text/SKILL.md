---
name: generate-text
description: Generate text under constraints (tone, format, safety).
...
## Intent
Execute **generate-text** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `generate-text`
