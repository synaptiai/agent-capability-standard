---
name: act-plan
description: Execute a plan using tools with checkpoints and verification.
...
## Intent
Execute **act-plan** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `act-plan`
