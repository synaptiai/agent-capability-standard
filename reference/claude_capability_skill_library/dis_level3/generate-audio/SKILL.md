---
name: generate-audio
description: Generate audio (or audio plan/spec) under constraints.
...
## Intent
Execute **generate-audio** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `generate-audio`
