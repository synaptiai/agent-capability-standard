...
description: Forecast attribute evolution (e.g., score, metric).
...
## Intent
Execute **forecast-attribute** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `forecast-attribute`
