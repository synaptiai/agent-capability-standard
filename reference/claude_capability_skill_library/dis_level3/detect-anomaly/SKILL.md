---
name: detect-anomaly
description: Detect anomalies/outliers/violations relative to expected patterns.
...
## Intent
Execute **detect-anomaly** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `detect-anomaly`
