---
name: compare-impact
description: Compare impacts of interventions/options.
...
## Intent
Execute **compare-impact** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `compare-impact`
