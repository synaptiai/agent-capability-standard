...
description: Forecast downstream impact over time.
...
## Intent
Execute **forecast-impact** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `forecast-impact`
