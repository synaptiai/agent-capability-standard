---
name: detect-entity
description: Detect presence of an entity/object/class in data.
...
## Intent
Execute **detect-entity** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `detect-entity`
