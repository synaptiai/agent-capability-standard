---
name: compare-people
description: Compare people/roles by evidence-based criteria (non-sensitive).
...
## Intent
Execute **compare-people** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `compare-people`
