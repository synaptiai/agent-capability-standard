---
name: plan
description: Create an executable plan with dependencies, risks, checkpoints, and rollback.
...
## Intent
Execute **plan** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `plan`
