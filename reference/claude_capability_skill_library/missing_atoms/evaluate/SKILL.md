---
name: evaluate
description: Score outputs with rubrics/metrics; compare to baselines.
...
## Intent
Execute **evaluate** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `evaluate`
