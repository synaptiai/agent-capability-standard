---
name: audit
description: Produce an audit trail of actions, tools used, diffs, and rationale.
argument-hint: "[scope] [time-window]"
...
## Intent
Execute **audit** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `audit`
