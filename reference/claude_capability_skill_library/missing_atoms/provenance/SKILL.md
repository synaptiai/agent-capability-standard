---
name: provenance
description: Track sources, transformations, and decision lineage for outputs.
...
## Intent
Execute **provenance** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `provenance`
