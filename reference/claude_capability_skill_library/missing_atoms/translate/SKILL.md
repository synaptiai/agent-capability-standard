---
name: translate
description: Convert content across languages/register/format preserving meaning.
argument-hint: "[from] [to] [format]"
...
## Intent
Execute **translate** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `translate`
