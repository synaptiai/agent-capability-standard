---
name: improve
description: Iteratively refine artifact using feedback loops and verification gates.
...
## Intent
Execute **improve** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `improve`
