---
name: persist
description: Write stable learnings into CLAUDE.md or knowledge files with structure.
argument-hint: "[what-to-store] [where]"
...
## Intent
Execute **persist** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `persist`
