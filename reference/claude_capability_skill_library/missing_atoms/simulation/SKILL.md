---
name: simulation
description: Run or describe simulations/scenarios to stress-test assumptions.
...
## Intent
Execute **simulation** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `simulation`
