---
name: decide
description: Choose among alternatives using explicit objective functions and tradeoffs.
...
## Intent
Execute **decide** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `decide`
