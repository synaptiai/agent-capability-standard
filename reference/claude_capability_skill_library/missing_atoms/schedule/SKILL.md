---
name: schedule
description: Order work under deadlines/resources; produce a runbook timeline.
...
## Intent
Execute **schedule** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `schedule`
