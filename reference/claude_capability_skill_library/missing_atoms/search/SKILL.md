---
name: search
description: Find relevant items under uncertainty (repo/search/web) with traceability.
...
## Intent
Execute **search** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `search`
