---
name: model-schema
description: Create/extend a schema/ontology for the domain with invariants.
...
## Intent
Execute **model-schema** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `model-schema`
