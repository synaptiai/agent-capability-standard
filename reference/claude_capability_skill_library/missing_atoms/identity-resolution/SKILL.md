...
description: Resolve entity identity across aliases/records with collision handling.
...
## Intent
Execute **identity-resolution** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `identity-resolution`
