---
name: constrain
description: Enforce policies/guardrails and refuse unsafe actions; least privilege.
...
## Intent
Execute **constrain** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `constrain`
