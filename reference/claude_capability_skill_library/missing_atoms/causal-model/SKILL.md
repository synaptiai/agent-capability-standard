---
name: causal-model
description: Represent causal assumptions (DAGs, mechanisms) and intervention effects.
...
## Intent
Execute **causal-model** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `causal-model`
