---
name: recall
description: Retrieve prior decisions/rationale and apply consistently.
...
## Intent
Execute **recall** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `recall`
