...
description: Quantify uncertainty: distributions, confidence, intervals, epistemic vs aleatoric.
...
## Intent
Execute **uncertainty-model** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `uncertainty-model`
