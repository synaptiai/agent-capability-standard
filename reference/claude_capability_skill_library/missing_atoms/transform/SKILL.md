---
name: transform
description: Convert data between formats/schemas/representations with explicit loss accounting.
...
## Intent
Execute **transform** (layer: ACTION).
...
3) Execute `transform` deterministically where possible.
