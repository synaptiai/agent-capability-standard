---
name: summarize
description: Compress information into a decision-ready brief with next actions.
...
## Intent
Execute **summarize** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `summarize`
