---
name: validate
description: Check fitness vs user intent + real constraints; surface mismatches.
...
## Intent
Execute **validate** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `validate`
