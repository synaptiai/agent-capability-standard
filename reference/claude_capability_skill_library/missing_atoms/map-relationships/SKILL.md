...
description: Build a relationship graph (entities, edges, constraints).
...
## Intent
Execute **map-relationships** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `map-relationships`
