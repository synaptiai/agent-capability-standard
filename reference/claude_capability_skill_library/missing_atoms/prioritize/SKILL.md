---
name: prioritize
description: Rank tasks/options by value, urgency, risk, and dependency.
...
## Intent
Execute **prioritize** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `prioritize`
