---
name: synchronize
description: Merge outputs, resolve conflicts, and reconcile constraints.
...
## Intent
Execute **synchronize** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `synchronize`
