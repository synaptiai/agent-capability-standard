---
name: digital-twin
description: Model real-world assets/processes as digital representations + sync rules.
...
## Intent
Execute **digital-twin** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `digital-twin`
