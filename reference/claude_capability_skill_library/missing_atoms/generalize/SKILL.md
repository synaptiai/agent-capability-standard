---
name: generalize
description: Extract reusable patterns/heuristics from examples.
...
## Intent
Execute **generalize** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `generalize`
