...
description: Reason over time: ordering, duration, periodicity, time windows.
...
## Intent
Execute **temporal-reasoning** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `temporal-reasoning`
