---
name: optimize
description: Tune parameters/choices to improve an objective under constraints.
...
## Intent
Execute **optimize** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `optimize`
