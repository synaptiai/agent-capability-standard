...
description: Reason over space: geometry, proximity, layout constraints (abstract).
...
## Intent
Execute **spatial-reasoning** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `spatial-reasoning`
