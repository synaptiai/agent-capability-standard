---
name: grounding
description: Attach claims to evidence anchors (files/lines/observations) + provenance.
...
## Intent
Execute **grounding** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `grounding`
...
Return:
- Claims: <bullet list>
- Evidence anchors: <file:line, tool outputs, citations>
- Transformations: <how info was derived>
