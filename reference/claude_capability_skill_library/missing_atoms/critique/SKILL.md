---
name: critique
description: Find failure modes, edge cases, ambiguity, and exploit paths.
...
## Intent
Execute **critique** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `critique`
