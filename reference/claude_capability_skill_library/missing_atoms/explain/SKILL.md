---
name: explain
description: Produce clear reasoning + assumptions + causal chain (no fluff).
...
## Intent
Execute **explain** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `explain`
