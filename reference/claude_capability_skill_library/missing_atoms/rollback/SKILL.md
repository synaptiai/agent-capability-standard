---
name: rollback
description: Safely undo changes using checkpoints/diffs; restore prior state.
...
## Intent
Execute **rollback** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `rollback`
