---
name: world-state
description: Represent current world/system state as structured variables + confidence.
...
## Intent
Execute **world-state** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `world-state`
