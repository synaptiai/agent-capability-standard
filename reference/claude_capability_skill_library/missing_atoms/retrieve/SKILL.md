---
name: retrieve
description: Fetch known facts from specified sources with citations/evidence pointers.
...
## Intent
Execute **retrieve** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `retrieve`
