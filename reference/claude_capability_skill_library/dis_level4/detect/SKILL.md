---
name: detect
description: Determine whether something exists/present in the given data.
...
## Intent
Execute **detect** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `detect`
