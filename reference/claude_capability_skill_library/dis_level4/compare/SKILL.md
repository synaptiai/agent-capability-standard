---
name: compare
description: Compare alternatives using explicit criteria, tradeoffs, and recommendation.
...
## Intent
Execute **compare** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `compare`
