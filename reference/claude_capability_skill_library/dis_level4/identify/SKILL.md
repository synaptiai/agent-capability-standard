---
name: identify
description: Classify which entity/label best matches observed evidence.
...
## Intent
Execute **identify** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `identify`
