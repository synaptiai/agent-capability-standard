---
name: generate
description: Create a new artifact (text/plan/data) under constraints.
...
## Intent
Execute **generate** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `generate`
