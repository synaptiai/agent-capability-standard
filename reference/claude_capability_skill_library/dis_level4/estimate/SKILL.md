---
name: estimate
description: Produce a numeric estimate (value/probability) with uncertainty and assumptions.
argument-hint: "[quantity] [inputs] [assumptions]"
...
## Intent
Execute **estimate** as a reusable, evidence-first capability.

Success means you return the output contract **with grounded evidence** and **explicit assumptions**.

## Inputs
- Required: the data/context needed to run `estimate`
